...
--
-- Name: gem; Type: SCHEMA; Schema: -; Owner: gemdba
--

CREATE SCHEMA gem;


ALTER SCHEMA gem OWNER TO gemdba;
...
--
-- Name: mv_date; Type: TYPE; Schema: gem; Owner: gemdba
--

CREATE TYPE mv_date AS (
	minimum date,
	maximum date,
	preferred date
);
...
ALTER TYPE gem.mv_date OWNER TO gemdba;

--
-- Name: mv_decimal; Type: TYPE; Schema: gem; Owner: gemdba
--

CREATE TYPE mv_decimal AS (
	minimum numeric,
	maximum numeric,
	preferred numeric
);
...
ALTER TYPE gem.mv_decimal OWNER TO gemdba;

--
-- Name: mv_integer; Type: TYPE; Schema: gem; Owner: gemdba
--

CREATE TYPE mv_integer AS (
	minimum integer,
	maximum integer,
	preferred integer
);
...
ALTER TYPE gem.mv_integer OWNER TO gemdba;

--
-- Name: mv_smallint; Type: TYPE; Schema: gem; Owner: gemdba
--

CREATE TYPE mv_smallint AS (
	minimum smallint,
	maximum smallint,
	preferred smallint
);
...
ALTER TYPE gem.mv_smallint OWNER TO gemdba;
...
--
-- Name: set_created_date(); Type: FUNCTION; Schema: gem; Owner: gemdba
--

CREATE FUNCTION set_created_date() RETURNS trigger
    LANGUAGE plpgsql
    AS $$ BEGIN  NEW.created_date = CURRENT_DATE; RETURN NEW; END; $$;


ALTER FUNCTION gem.set_created_date() OWNER TO gemdba;

--
-- Name: set_modified_date(); Type: FUNCTION; Schema: gem; Owner: gemdba
--

CREATE FUNCTION set_modified_date() RETURNS trigger
    LANGUAGE plpgsql
    AS $$BEGIN NEW.modified_date = CURRENT_DATE; RETURN NEW; END; $$;


ALTER FUNCTION gem.set_modified_date() OWNER TO gemdba;
...
--
-- Name: databasechangelog; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--
...
ALTER TABLE gem.databasechangelog OWNER TO gemdba;

--
-- Name: databasechangeloglock; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--
...
ALTER TABLE gem.databasechangeloglock OWNER TO gemdba;

--
-- Name: fearth_bibliographic_reference; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_bibliographic_reference (
    biblio_id integer NOT NULL,
    reference character varying(480) NOT NULL
);


ALTER TABLE gem.fearth_bibliographic_reference OWNER TO gemdba;

--
-- Name: TABLE fearth_bibliographic_reference; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_bibliographic_reference IS 'Publication references formatted in the Bulletin of the Seismological Society of America style.';


--
-- Name: fearth_bibliographic_reference_biblio_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_bibliographic_reference_biblio_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_bibliographic_reference_biblio_id_seq OWNER TO gemdba;

--
-- Name: fearth_bibliographic_reference_biblio_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_bibliographic_reference_biblio_id_seq OWNED BY fearth_bibliographic_reference.biblio_id;


--
-- Name: fearth_blind_fault_summary; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_blind_fault_summary (
    blind_fault_summary_id integer NOT NULL,
    aseismic_slip_factor numeric(3,2) NOT NULL,
    compiler_id smallint,
    completion_id smallint,
    contributor_id smallint,
    dip mv_integer,
    dip_dir smallint,
    displacement mv_decimal,
    is_active boolean,
    is_episodic boolean,
    last_movement mv_integer,
    length numeric(6,2),
    lower_sm_depth mv_decimal,
    name character varying(96) NOT NULL,
    recurrence_interval mv_integer,
    strike_slip_rate mv_decimal,
    slip_type_id smallint,
    strike smallint,
    upper_sm_depth mv_decimal,
    created_date date,
    modified_date date,
    polygon public.geometry,
    net_slip_rate mv_decimal,
    vert_slip_rate mv_decimal,
    CONSTRAINT ck_asf CHECK (((aseismic_slip_factor >= 0.0) AND (aseismic_slip_factor <= 1.0))),
    CONSTRAINT ck_dip_angle CHECK ((((((((dip).minimum >= 0) AND ((dip).minimum <= 90)) AND ((dip).maximum >= 0)) AND ((dip).maximum <= 90)) AND ((dip).preferred >= 0)) AND ((dip).preferred <= 90))),
    CONSTRAINT ck_dip_dir CHECK (((dip_dir >= 1) AND (dip_dir <= 360))),
    CONSTRAINT ck_strike_angle CHECK (((strike >= 1) AND (strike <= 360))),
    CONSTRAINT enforce_dims_polygon CHECK ((public.st_ndims(polygon) = 2)),
    CONSTRAINT enforce_geotype_polygon CHECK (((public.geometrytype(polygon) = 'POLYGON'::text) OR (polygon IS NULL))),
    CONSTRAINT enforce_srid_polygon CHECK ((public.st_srid(polygon) = 4326))
);


ALTER TABLE gem.fearth_blind_fault_summary OWNER TO gemdba;

--
-- Name: fearth_blind_fault_summary_blind_fault_summary_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_blind_fault_summary_blind_fault_summary_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_blind_fault_summary_blind_fault_summary_id_seq OWNER TO gemdba;

--
-- Name: fearth_blind_fault_summary_blind_fault_summary_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_blind_fault_summary_blind_fault_summary_id_seq OWNED BY fearth_blind_fault_summary.blind_fault_summary_id;


--
-- Name: fearth_compilation_note; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_compilation_note (
    compilation_note_id integer NOT NULL,
    observation_id integer NOT NULL,
    note character varying(254) NOT NULL
);


ALTER TABLE gem.fearth_compilation_note OWNER TO gemdba;

--
-- Name: TABLE fearth_compilation_note; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_compilation_note IS 'Compilation notes/comments for the GEM entities.';


--
-- Name: fearth_compilation_note_compilation_note_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_compilation_note_compilation_note_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_compilation_note_compilation_note_id_seq OWNER TO gemdba;

--
-- Name: fearth_compilation_note_compilation_note_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_compilation_note_compilation_note_id_seq OWNED BY fearth_compilation_note.compilation_note_id;


--
-- Name: fearth_completion; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_completion (
    completion_id integer NOT NULL,
    parameter_id integer NOT NULL,
    observation_id integer NOT NULL,
    data_completion_id integer,
    description character varying(254)
);


ALTER TABLE gem.fearth_completion OWNER TO gemdba;

--
-- Name: TABLE fearth_completion; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_completion IS 'Parameter completion factors';


--
-- Name: fearth_completion_completion_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_completion_completion_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_completion_completion_id_seq OWNER TO gemdba;

--
-- Name: fearth_completion_completion_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_completion_completion_id_seq OWNED BY fearth_completion.completion_id;


--
-- Name: fearth_data_completion; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_data_completion (
    data_completion_id smallint NOT NULL,
    completion character varying(80) NOT NULL
);


ALTER TABLE gem.fearth_data_completion OWNER TO gemdba;

--
-- Name: TABLE fearth_data_completion; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_data_completion IS 'Completion categories for data compilation.';


--
-- Name: fearth_fault_source; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_fault_source (
    fault_source_id integer NOT NULL,
    fault_summary_id integer,
    aseismic_slip_factor numeric(3,2) NOT NULL,
    compiler_id smallint NOT NULL,
    completion_id smallint,
    contributor_id smallint NOT NULL,
    dip mv_integer NOT NULL,
    dip_dir smallint NOT NULL,
    last_movement mv_integer,
    length mv_decimal,
    lower_sm_depth mv_decimal,
    magnitude mv_decimal NOT NULL,
    name character varying(96) NOT NULL,
    recurrence_interval mv_integer,
    slip_rate mv_decimal NOT NULL,
    slip_type_id smallint NOT NULL,
    upper_sm_depth mv_decimal,
    created_date date,
    modified_date date,
    tectonic_region character varying(96),
    area mv_decimal,
    width mv_decimal,
    polygon public.geometry,
    CONSTRAINT ck_asf CHECK (((aseismic_slip_factor >= 0.0) AND (aseismic_slip_factor <= 1.0))),
...
ALTER TABLE gem.fearth_fault_source OWNER TO gemdba;

--
-- Name: fearth_fault_source_fault_source_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_fault_source_fault_source_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_fault_source_fault_source_id_seq OWNER TO gemdba;

--
-- Name: fearth_fault_source_fault_source_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_fault_source_fault_source_id_seq OWNED BY fearth_fault_source.fault_source_id;


--
-- Name: fearth_fault_summary; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_fault_summary (
    fault_summary_id integer NOT NULL,
    aseismic_slip_factor numeric(3,2) NOT NULL,
    compiler_id smallint,
    completion_id smallint,
    contributor_id smallint,
    average_dip mv_integer,
    dip_dir smallint,
    displacement mv_decimal,
    downthrown_side_id smallint,
    is_active boolean,
    is_episodic boolean,
    ...
    vert_slip_rate mv_decimal,
    CONSTRAINT ck_asf CHECK (((aseismic_slip_factor >= 0.0) AND (aseismic_slip_factor <= 1.0))),
    CONSTRAINT ck_dip_angle CHECK ((((((((average_dip).minimum >= 0) AND ((average_dip).minimum <= 90)) AND ((average_dip).maximum >= 0)) AND ((average_dip).maximum <= 90)) AND ((average_dip).preferred >= 0)) AND ((average_dip).preferred <= 90))),
    CONSTRAINT ck_dip_dir CHECK (((dip_dir >= 1) AND (dip_dir <= 360))),
    CONSTRAINT ck_strike_angle CHECK (((strike >= 1) AND (strike <= 360)))
);


ALTER TABLE gem.fearth_fault_summary OWNER TO gemdba;

--
-- Name: fearth_fault_summary_fault_summary_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_fault_summary_fault_summary_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_fault_summary_fault_summary_id_seq OWNER TO gemdba;

--
-- Name: fearth_fault_summary_fault_summary_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_fault_summary_fault_summary_id_seq OWNED BY fearth_fault_summary.fault_summary_id;


--
-- Name: fearth_fault_synopsis; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_fault_synopsis (
    fault_synopsis_id integer NOT NULL,
    fault_summary_id integer NOT NULL,
    location character varying(254),
    name_origin character varying(254),
    synopsis character varying(420)
);


ALTER TABLE gem.fearth_fault_synopsis OWNER TO gemdba;

--
-- Name: TABLE fearth_fault_synopsis; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_fault_synopsis IS 'GEM Fault Synopsis Information.';


--
-- Name: fearth_fault_synopsis_fault_synopsis_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_fault_synopsis_fault_synopsis_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_fault_synopsis_fault_synopsis_id_seq OWNER TO gemdba;

--
-- Name: fearth_fault_synopsis_fault_synopsis_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_fault_synopsis_fault_synopsis_id_seq OWNED BY fearth_fault_synopsis.fault_synopsis_id;


--
-- Name: fearth_fold; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_fold (
    fold_id integer NOT NULL,
    compiler_id smallint,
    completion_id smallint,
    contributor_id smallint,
    dip_axial_plane integer,
    dip_dir_shallow_limb smallint,
    dip_dir_steep_limb smallint,
    dip_shallow_limb mv_smallint,
    dip_steep_limb mv_smallint,
    growth_horizontal mv_decimal,
    growth_vertical mv_decimal,
    is_active boolean,
    is_episodic boolean,
    last_movement mv_integer,
    last_movement_cat_id integer,
    length numeric(6,2),
    name character varying(96) NOT NULL,
    plunge mv_integer,
    plunge_dir integer,
    marker_age integer,
    tilt_shallow_limb numeric,
    tilt_steep_limb numeric,
    type_id smallint NOT NULL,
    created_date date,
    modified_date date,
    dip_dir_axial_plane integer,
    CONSTRAINT ck_dip_angle_shallow CHECK ((((((((dip_shallow_limb).minimum >= 0) AND ((dip_shallow_limb).minimum <= 90)) AND ((dip_shallow_limb).maximum >= 0)) AND ((dip_shallow_limb).maximum <= 90)) AND ((dip_shallow_limb).preferred >= 0)) AND ((dip_shallow_limb).preferred <= 90))),
    CONSTRAINT ck_dip_angle_steep CHECK ((((((((dip_steep_limb).minimum >= 0) AND ((dip_steep_limb).minimum <= 90)) AND ((dip_steep_limb).maximum >= 0)) AND ((dip_steep_limb).maximum <= 90)) AND ((dip_steep_limb).preferred >= 0)) AND ((dip_steep_limb).preferred <= 90))),
    CONSTRAINT ck_dip_axial_plane CHECK (((dip_axial_plane >= 0) AND (dip_axial_plane <= 90))),
    CONSTRAINT ck_dip_dir_shallow CHECK (((dip_dir_shallow_limb >= 1) AND (dip_dir_shallow_limb <= 360))),
    CONSTRAINT ck_dip_dir_steep CHECK (((dip_dir_steep_limb >= 1) AND (dip_dir_steep_limb <= 360))),
    CONSTRAINT ck_plunge CHECK ((((((((plunge).minimum >= 0) AND ((plunge).minimum <= 90)) AND ((plunge).maximum >= 0)) AND ((plunge).maximum <= 90)) AND ((plunge).preferred >= 0)) AND ((plunge).preferred <= 90))),
    CONSTRAINT ck_plunge_dir CHECK (((plunge_dir >= 1) AND (plunge_dir <= 360)))
);


ALTER TABLE gem.fearth_fold OWNER TO gemdba;

--
-- Name: fearth_fold_fold_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_fold_fold_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_fold_fold_id_seq OWNER TO gemdba;

--
-- Name: fearth_fold_fold_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_fold_fold_id_seq OWNED BY fearth_fold.fold_id;


--
-- Name: fearth_fold_trace; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_fold_trace (
    fold_trace_id integer NOT NULL,
    fold_id integer,
    expression_id integer,
    location_method_id integer,
    name character varying(96),
...
ALTER TABLE gem.fearth_fold_trace OWNER TO gemdba;

--
-- Name: fearth_fold_trace_fold_trace_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_fold_trace_fold_trace_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_fold_trace_fold_trace_id_seq OWNER TO gemdba;

--
-- Name: fearth_fold_trace_fold_trace_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_fold_trace_fold_trace_id_seq OWNED BY fearth_fold_trace.fold_trace_id;


--
-- Name: fearth_gem_role; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_gem_role (
...
ALTER TABLE gem.fearth_gem_role OWNER TO gemdba;

--
-- Name: TABLE fearth_gem_role; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_gem_role IS 'GEM User roles.';


--
-- Name: fearth_gem_user; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_gem_user (
    user_id integer NOT NULL,
    name character varying(64) NOT NULL
);


ALTER TABLE gem.fearth_gem_user OWNER TO gemdba;

--
-- Name: TABLE fearth_gem_user; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_gem_user IS 'GEM Users.';


--
-- Name: fearth_gem_user_role; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_gem_user_role (
...
ALTER TABLE gem.fearth_gem_user_role OWNER TO gemdba;

--
-- Name: TABLE fearth_gem_user_role; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_gem_user_role IS 'Assigned User roles.';


--
-- Name: fearth_gem_user_role_user_role_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_gem_user_role_user_role_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_gem_user_role_user_role_id_seq OWNER TO gemdba;

--
-- Name: fearth_gem_user_role_user_role_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_gem_user_role_user_role_id_seq OWNED BY fearth_gem_user_role.user_role_id;


--
-- Name: fearth_gem_user_user_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_gem_user_user_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_gem_user_user_id_seq OWNER TO gemdba;

--
-- Name: fearth_gem_user_user_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_gem_user_user_id_seq OWNED BY fearth_gem_user.user_id;


--
-- Name: fearth_geomorphic_expression; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_geomorphic_expression (
    expression_id smallint NOT NULL,
    expression character varying(64) NOT NULL
);


ALTER TABLE gem.fearth_geomorphic_expression OWNER TO gemdba;

--
-- Name: TABLE fearth_geomorphic_expression; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_geomorphic_expression IS 'The on ground expression for the feature.';


--
-- Name: fearth_location_method; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_location_method (
    method_id smallint NOT NULL,
    method character varying(24) NOT NULL
);


ALTER TABLE gem.fearth_location_method OWNER TO gemdba;

--
-- Name: TABLE fearth_location_method; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_location_method IS 'The method used for digitising the feature.';


--
-- Name: fearth_lookup; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_lookup (
...
ALTER TABLE gem.fearth_lookup OWNER TO gemdba;

--
-- Name: TABLE fearth_lookup; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_lookup IS 'GEM Centralised lookup values';


--
-- Name: fearth_lookup_lookup_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_lookup_lookup_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_lookup_lookup_id_seq OWNER TO gemdba;

--
-- Name: fearth_lookup_lookup_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_lookup_lookup_id_seq OWNED BY fearth_lookup.lookup_id;


--
-- Name: fearth_neotectonic_section; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_neotectonic_section (
    neotectonic_section_id integer NOT NULL,
    fault_summary_id integer,
    average_dip mv_integer,
    is_active boolean,
    is_episodic boolean,
    surface_dip mv_integer,
    name character varying(96),
    aseismic_slip_factor numeric(3,2) NOT NULL,
    compiler_id smallint,
    completion_id smallint,
...
ALTER TABLE gem.fearth_neotectonic_section OWNER TO gemdba;

--
-- Name: fearth_neotectonic_section_neotectonic_section_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_neotectonic_section_neotectonic_section_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_neotectonic_section_neotectonic_section_id_seq OWNER TO gemdba;

--
-- Name: fearth_neotectonic_section_neotectonic_section_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_neotectonic_section_neotectonic_section_id_seq OWNED BY fearth_neotectonic_section.neotectonic_section_id;


--
-- Name: fearth_observation; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_observation (
    observation_id integer NOT NULL,
...
ALTER TABLE gem.fearth_observation OWNER TO gemdba;

--
-- Name: TABLE fearth_observation; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_observation IS 'Observation entry for the GEM entities.';


--
-- Name: fearth_observation_observation_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_observation_observation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_observation_observation_id_seq OWNER TO gemdba;

--
-- Name: fearth_observation_observation_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_observation_observation_id_seq OWNED BY fearth_observation.observation_id;


--
-- Name: fearth_observation_type; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_observation_type (
    observation_type_id smallint NOT NULL,
    name character varying(24) NOT NULL
);


ALTER TABLE gem.fearth_observation_type OWNER TO gemdba;

--
-- Name: TABLE fearth_observation_type; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_observation_type IS 'GEM named entities.';


--
-- Name: fearth_parameter; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_parameter (
    parameter_id integer NOT NULL,
    observation_type_id smallint NOT NULL,
...
ALTER TABLE gem.fearth_parameter OWNER TO gemdba;

--
-- Name: TABLE fearth_parameter; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_parameter IS 'GEM named parameters.';


--
-- Name: fearth_result; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_result (
    result_id integer NOT NULL,
    parameter_id smallint NOT NULL,
    derivation_type_id smallint,
    min_lookup smallint,
    min_value character varying(48),
    max_lookup smallint,
    max_value character varying(48),
    pref_lookup smallint,
    observation_id integer,
    derivation character varying(254),
    pref_value character varying(96)
);


ALTER TABLE gem.fearth_result OWNER TO gemdba;

--
-- Name: TABLE fearth_result; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_result IS 'Description of how the parameter values were derived.';


--
-- Name: fearth_parameter_derivation_parameter_derivation_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_parameter_derivation_parameter_derivation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_parameter_derivation_parameter_derivation_id_seq OWNER TO gemdba;

--
-- Name: fearth_parameter_derivation_parameter_derivation_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_parameter_derivation_parameter_derivation_id_seq OWNED BY fearth_result.result_id;


--
-- Name: fearth_parameter_lookup; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_parameter_lookup (
    parameter_id smallint NOT NULL,
    lookup_id smallint NOT NULL
);


ALTER TABLE gem.fearth_parameter_lookup OWNER TO gemdba;

--
-- Name: TABLE fearth_parameter_lookup; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_parameter_lookup IS 'GEM parameter lookup list candidates.';


--
-- Name: fearth_parameter_parameter_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_parameter_parameter_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_parameter_parameter_id_seq OWNER TO gemdba;

--
-- Name: fearth_parameter_parameter_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_parameter_parameter_id_seq OWNED BY fearth_parameter.parameter_id;


--
-- Name: fearth_reference; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_reference (
...
ALTER TABLE gem.fearth_reference OWNER TO gemdba;

--
-- Name: TABLE fearth_reference; Type: COMMENT; Schema: gem; Owner: gemdba
--

COMMENT ON TABLE fearth_reference IS 'Published references for the GEM entities.';


--
-- Name: fearth_reference_reference_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_reference_reference_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_reference_reference_id_seq OWNER TO gemdba;

--
-- Name: fearth_reference_reference_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_reference_reference_id_seq OWNED BY fearth_reference.reference_id;


--
-- Name: fearth_section_trace; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_section_trace (
    section_trace_id integer NOT NULL,
    neotectonic_section_id integer,
    expression_id integer,
    location_method_id integer,
    name character varying(96),
    notes character varying(254),
...
ALTER TABLE gem.fearth_section_trace OWNER TO gemdba;

--
-- Name: fearth_section_trace_section_trace_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_section_trace_section_trace_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_section_trace_section_trace_id_seq OWNER TO gemdba;

--
-- Name: fearth_section_trace_section_trace_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_section_trace_section_trace_id_seq OWNED BY fearth_section_trace.section_trace_id;


--
-- Name: fearth_site; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE fearth_site (
    ...
    geom public.geometry,
    accuracy integer,
    CONSTRAINT enforce_dims_geom CHECK ((public.st_ndims(geom) = 0)),
    CONSTRAINT enforce_geotype_geom CHECK (((public.geometrytype(geom) = 'POINT'::text) OR (geom IS NULL))),
    CONSTRAINT enforce_srid_geom CHECK ((public.st_srid(geom) = 4326))
);


ALTER TABLE gem.fearth_site OWNER TO gemdba;

--
-- Name: fearth_site_site_id_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE fearth_site_site_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.fearth_site_site_id_seq OWNER TO gemdba;

--
-- Name: fearth_site_site_id_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE fearth_site_site_id_seq OWNED BY fearth_site.site_id;


--
-- Name: tracetest; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--
...
ALTER TABLE gem.tracetest OWNER TO gemdba;

--
-- Name: usa_singlepart; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE usa_singlepart (
    gid integer NOT NULL,
    name character varying(80),
    num character varying(6),
    scale integer,
    geom_expr character varying(50),
    accuracy integer,
    temp_id integer,
    et_id integer,
    geom public.geometry,
...
ALTER TABLE gem.usa_singlepart OWNER TO gemdba;

--
-- Name: usa_singlepart_folds; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE usa_singlepart_folds (
    gid integer NOT NULL,
    name character varying(80),
    num character varying(6),
    scale integer,
...
ALTER TABLE gem.usa_singlepart_folds OWNER TO gemdba;

--
-- Name: usa_singlepart_folds_gid_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE usa_singlepart_folds_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.usa_singlepart_folds_gid_seq OWNER TO gemdba;

--
-- Name: usa_singlepart_folds_gid_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE usa_singlepart_folds_gid_seq OWNED BY usa_singlepart_folds.gid;


--
-- Name: usa_singlepart_gid_seq; Type: SEQUENCE; Schema: gem; Owner: gemdba
--

CREATE SEQUENCE usa_singlepart_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE gem.usa_singlepart_gid_seq OWNER TO gemdba;

--
-- Name: usa_singlepart_gid_seq; Type: SEQUENCE OWNED BY; Schema: gem; Owner: gemdba
--

ALTER SEQUENCE usa_singlepart_gid_seq OWNED BY usa_singlepart.gid;


--
-- Name: usatest; Type: TABLE; Schema: gem; Owner: gemdba; Tablespace: 
--

CREATE TABLE usatest (
    num character varying(6)
);


ALTER TABLE gem.usatest OWNER TO gemdba;
...
--
-- Name: biblio_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_bibliographic_reference ALTER COLUMN biblio_id SET DEFAULT nextval('fearth_bibliographic_reference_biblio_id_seq'::regclass);


--
-- Name: blind_fault_summary_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_blind_fault_summary ALTER COLUMN blind_fault_summary_id SET DEFAULT nextval('fearth_blind_fault_summary_blind_fault_summary_id_seq'::regclass);


--
-- Name: compilation_note_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_compilation_note ALTER COLUMN compilation_note_id SET DEFAULT nextval('fearth_compilation_note_compilation_note_id_seq'::regclass);


--
-- Name: completion_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_completion ALTER COLUMN completion_id SET DEFAULT nextval('fearth_completion_completion_id_seq'::regclass);


--
-- Name: fault_source_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_source ALTER COLUMN fault_source_id SET DEFAULT nextval('fearth_fault_source_fault_source_id_seq'::regclass);


--
-- Name: fault_summary_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_summary ALTER COLUMN fault_summary_id SET DEFAULT nextval('fearth_fault_summary_fault_summary_id_seq'::regclass);


--
-- Name: fault_synopsis_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_synopsis ALTER COLUMN fault_synopsis_id SET DEFAULT nextval('fearth_fault_synopsis_fault_synopsis_id_seq'::regclass);


--
-- Name: fold_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold ALTER COLUMN fold_id SET DEFAULT nextval('fearth_fold_fold_id_seq'::regclass);


--
-- Name: fold_trace_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold_trace ALTER COLUMN fold_trace_id SET DEFAULT nextval('fearth_fold_trace_fold_trace_id_seq'::regclass);


--
-- Name: user_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_gem_user ALTER COLUMN user_id SET DEFAULT nextval('fearth_gem_user_user_id_seq'::regclass);


--
-- Name: user_role_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_gem_user_role ALTER COLUMN user_role_id SET DEFAULT nextval('fearth_gem_user_role_user_role_id_seq'::regclass);


--
-- Name: lookup_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_lookup ALTER COLUMN lookup_id SET DEFAULT nextval('fearth_lookup_lookup_id_seq'::regclass);


--
-- Name: neotectonic_section_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_neotectonic_section ALTER COLUMN neotectonic_section_id SET DEFAULT nextval('fearth_neotectonic_section_neotectonic_section_id_seq'::regclass);


--
-- Name: observation_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_observation ALTER COLUMN observation_id SET DEFAULT nextval('fearth_observation_observation_id_seq'::regclass);


--
-- Name: parameter_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_parameter ALTER COLUMN parameter_id SET DEFAULT nextval('fearth_parameter_parameter_id_seq'::regclass);


--
-- Name: reference_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_reference ALTER COLUMN reference_id SET DEFAULT nextval('fearth_reference_reference_id_seq'::regclass);


--
-- Name: result_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_result ALTER COLUMN result_id SET DEFAULT nextval('fearth_parameter_derivation_parameter_derivation_id_seq'::regclass);


--
-- Name: section_trace_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_section_trace ALTER COLUMN section_trace_id SET DEFAULT nextval('fearth_section_trace_section_trace_id_seq'::regclass);


--
-- Name: site_id; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_site ALTER COLUMN site_id SET DEFAULT nextval('fearth_site_site_id_seq'::regclass);


--
-- Name: gid; Type: DEFAULT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY usa_singlepart ALTER COLUMN gid SET DEFAULT nextval('usa_singlepart_gid_seq'::regclass);
...
ALTER TABLE ONLY usa_singlepart_folds ALTER COLUMN gid SET DEFAULT nextval('usa_singlepart_folds_gid_seq'::regclass);


--
-- Name: fearth_blind_fault_summary_pkey; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_blind_fault_summary
    ADD CONSTRAINT fearth_blind_fault_summary_pkey PRIMARY KEY (blind_fault_summary_id);


--
-- Name: fearth_data_completion_completion_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_data_completion
    ADD CONSTRAINT fearth_data_completion_completion_key UNIQUE (completion);


--
-- Name: fearth_fault_source_pkey; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_fault_source
    ADD CONSTRAINT fearth_fault_source_pkey PRIMARY KEY (fault_source_id);


--
-- Name: fearth_fault_summary_pkey; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_fault_summary
    ADD CONSTRAINT fearth_fault_summary_pkey PRIMARY KEY (fault_summary_id);


--
-- Name: fearth_fold_pkey; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_fold
    ADD CONSTRAINT fearth_fold_pkey PRIMARY KEY (fold_id);


--
-- Name: fearth_gem_user_name_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_gem_user
    ADD CONSTRAINT fearth_gem_user_name_key UNIQUE (name);


--
-- Name: fearth_gem_user_role_role_desc_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_gem_role
    ADD CONSTRAINT fearth_gem_user_role_role_desc_key UNIQUE (role_desc);


--
-- Name: fearth_gem_user_role_role_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_gem_role
    ADD CONSTRAINT fearth_gem_user_role_role_key UNIQUE (role);


--
-- Name: fearth_geomorphic_expression_expression_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_geomorphic_expression
    ADD CONSTRAINT fearth_geomorphic_expression_expression_key UNIQUE (expression);


--
-- Name: fearth_location_method_method_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_location_method
    ADD CONSTRAINT fearth_location_method_method_key UNIQUE (method);


--
-- Name: fearth_observation_type_name_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_observation_type
    ADD CONSTRAINT fearth_observation_type_name_key UNIQUE (name);


--
-- Name: fearth_parameter_parameter_id_name_key; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_parameter
    ADD CONSTRAINT fearth_parameter_parameter_id_name_key UNIQUE (parameter_id, name);


--
-- Name: fearth_site_uq_name; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_site
    ADD CONSTRAINT fearth_site_uq_name UNIQUE (name);


--
-- Name: pk_bibliographic_reference; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_bibliographic_reference
    ADD CONSTRAINT pk_bibliographic_reference PRIMARY KEY (biblio_id);


--
-- Name: pk_compilation_note; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_compilation_note
    ADD CONSTRAINT pk_compilation_note PRIMARY KEY (compilation_note_id);


--
-- Name: pk_completion; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_completion
    ADD CONSTRAINT pk_completion PRIMARY KEY (completion_id);


--
-- Name: pk_data_completion; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_data_completion
    ADD CONSTRAINT pk_data_completion PRIMARY KEY (data_completion_id);


--
-- Name: pk_databasechangelog; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--
...
--
-- Name: pk_databasechangeloglock; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--
...
--
-- Name: pk_expression; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_geomorphic_expression
    ADD CONSTRAINT pk_expression PRIMARY KEY (expression_id);


--
-- Name: pk_fault_synopsis; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_fault_synopsis
    ADD CONSTRAINT pk_fault_synopsis PRIMARY KEY (fault_synopsis_id);


--
-- Name: pk_fearth_lookup; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_lookup
    ADD CONSTRAINT pk_fearth_lookup PRIMARY KEY (lookup_id);


--
-- Name: pk_fold_trace; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_fold_trace
    ADD CONSTRAINT pk_fold_trace PRIMARY KEY (fold_trace_id);


--
-- Name: pk_gem_user_role; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_gem_role
    ADD CONSTRAINT pk_gem_user_role PRIMARY KEY (role_id);


--
-- Name: pk_location_method; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_location_method
    ADD CONSTRAINT pk_location_method PRIMARY KEY (method_id);


--
-- Name: pk_neotectonic_section; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_neotectonic_section
    ADD CONSTRAINT pk_neotectonic_section PRIMARY KEY (neotectonic_section_id);


--
-- Name: pk_observation; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_observation
    ADD CONSTRAINT pk_observation PRIMARY KEY (observation_id);


--
-- Name: pk_observation_type; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--
...
--
-- Name: pk_parameter; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--
...
--
-- Name: pk_parameter_derivation; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_result
    ADD CONSTRAINT pk_parameter_derivation PRIMARY KEY (result_id);


--
-- Name: pk_reference; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_reference
    ADD CONSTRAINT pk_reference PRIMARY KEY (reference_id);


--
-- Name: pk_section_trace; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_section_trace
    ADD CONSTRAINT pk_section_trace PRIMARY KEY (section_trace_id);


--
-- Name: pk_site; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--
...
--
-- Name: pk_user; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--
...
--
-- Name: pk_user_role; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY fearth_gem_user_role
    ADD CONSTRAINT pk_user_role PRIMARY KEY (user_role_id);


--
-- Name: usa_singlepart_folds_pkey; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY usa_singlepart_folds
    ADD CONSTRAINT usa_singlepart_folds_pkey PRIMARY KEY (gid);


--
-- Name: usa_singlepart_pkey; Type: CONSTRAINT; Schema: gem; Owner: gemdba; Tablespace: 
--

ALTER TABLE ONLY usa_singlepart
    ADD CONSTRAINT usa_singlepart_pkey PRIMARY KEY (gid);
...
--
-- Name: update_created_date; Type: TRIGGER; Schema: gem; Owner: gemdba
--

CREATE TRIGGER update_created_date BEFORE INSERT ON fearth_observation FOR EACH ROW EXECUTE PROCEDURE set_created_date();


--
-- Name: update_modified_date; Type: TRIGGER; Schema: gem; Owner: gemdba
--

CREATE TRIGGER update_modified_date BEFORE UPDATE ON fearth_observation FOR EACH ROW EXECUTE PROCEDURE set_modified_date();


--
-- Name: fk_blind_fault_slip_type; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_blind_fault_summary
    ADD CONSTRAINT fk_blind_fault_slip_type FOREIGN KEY (slip_type_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_compilation_note_observation; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_compilation_note
    ADD CONSTRAINT fk_compilation_note_observation FOREIGN KEY (observation_id) REFERENCES fearth_observation(observation_id);


--
-- Name: fk_completion_data_completion; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_completion
    ADD CONSTRAINT fk_completion_data_completion FOREIGN KEY (data_completion_id) REFERENCES fearth_data_completion(data_completion_id);


--
-- Name: fk_completion_parameter; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_completion
    ADD CONSTRAINT fk_completion_parameter FOREIGN KEY (parameter_id) REFERENCES fearth_parameter(parameter_id);


--
-- Name: fk_fault_data_completion; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_summary
    ADD CONSTRAINT fk_fault_data_completion FOREIGN KEY (completion_id) REFERENCES fearth_data_completion(data_completion_id);
...
--
-- Name: fk_fault_fault_synopsis; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_synopsis
    ADD CONSTRAINT fk_fault_fault_synopsis FOREIGN KEY (fault_summary_id) REFERENCES fearth_fault_summary(fault_summary_id);


--
-- Name: fk_fault_octant; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_summary
    ADD CONSTRAINT fk_fault_octant FOREIGN KEY (downthrown_side_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_fault_slip_type_lookup; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_summary
    ADD CONSTRAINT fk_fault_slip_type_lookup FOREIGN KEY (slip_type_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_fault_source_fault_summary; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_source
    ADD CONSTRAINT fk_fault_source_fault_summary FOREIGN KEY (fault_summary_id) REFERENCES fearth_fault_summary(fault_summary_id);


--
-- Name: fk_fault_user; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_summary
    ADD CONSTRAINT fk_fault_user FOREIGN KEY (compiler_id) REFERENCES fearth_gem_user(user_id);
...
--
-- Name: fk_fault_user2; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fault_summary
    ADD CONSTRAINT fk_fault_user2 FOREIGN KEY (contributor_id) REFERENCES fearth_gem_user(user_id);
...
--
-- Name: fk_fold_age_cat_lookup; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold
    ADD CONSTRAINT fk_fold_age_cat_lookup FOREIGN KEY (last_movement_cat_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_fold_data_completion; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold
    ADD CONSTRAINT fk_fold_data_completion FOREIGN KEY (completion_id) REFERENCES fearth_data_completion(data_completion_id);


--
-- Name: fk_fold_trace_expression; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold_trace
    ADD CONSTRAINT fk_fold_trace_expression FOREIGN KEY (expression_id) REFERENCES fearth_geomorphic_expression(expression_id);


--
-- Name: fk_fold_trace_fold; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold_trace
    ADD CONSTRAINT fk_fold_trace_fold FOREIGN KEY (fold_id) REFERENCES fearth_fold(fold_id);


--
-- Name: fk_fold_trace_location_method; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold_trace
    ADD CONSTRAINT fk_fold_trace_location_method FOREIGN KEY (location_method_id) REFERENCES fearth_location_method(method_id);


--
-- Name: fk_fold_type_lookup; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold
    ADD CONSTRAINT fk_fold_type_lookup FOREIGN KEY (type_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_fold_user; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold
    ADD CONSTRAINT fk_fold_user FOREIGN KEY (compiler_id) REFERENCES fearth_gem_user(user_id);


--
-- Name: fk_fold_user2; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_fold
    ADD CONSTRAINT fk_fold_user2 FOREIGN KEY (contributor_id) REFERENCES fearth_gem_user(user_id);


--
-- Name: fk_gem_user; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_gem_user_role
    ADD CONSTRAINT fk_gem_user FOREIGN KEY (user_id) REFERENCES fearth_gem_user(user_id);


--
-- Name: fk_gem_user_role; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_gem_user_role
    ADD CONSTRAINT fk_gem_user_role FOREIGN KEY (role_id) REFERENCES fearth_gem_role(role_id);


--
-- Name: fk_neotectonic_section_fault_summary; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_neotectonic_section
    ADD CONSTRAINT fk_neotectonic_section_fault_summary FOREIGN KEY (fault_summary_id) REFERENCES fearth_fault_summary(fault_summary_id);


--
-- Name: fk_observation_observation_type; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_observation
    ADD CONSTRAINT fk_observation_observation_type FOREIGN KEY (observation_type_id) REFERENCES fearth_observation_type(observation_type_id);


--
-- Name: fk_observation_section; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_observation
    ADD CONSTRAINT fk_observation_section FOREIGN KEY (section_id) REFERENCES fearth_neotectonic_section(neotectonic_section_id);


--
-- Name: fk_observation_site; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_observation
    ADD CONSTRAINT fk_observation_site FOREIGN KEY (site_id) REFERENCES fearth_site(site_id);


--
-- Name: fk_observation_user1; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_observation
    ADD CONSTRAINT fk_observation_user1 FOREIGN KEY (compiler_id) REFERENCES fearth_gem_user(user_id);


--
-- Name: fk_observation_user2; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_observation
    ADD CONSTRAINT fk_observation_user2 FOREIGN KEY (contributor_id) REFERENCES fearth_gem_user(user_id);


--
-- Name: fk_parameter_derivation_parameter; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_result
    ADD CONSTRAINT fk_parameter_derivation_parameter FOREIGN KEY (parameter_id) REFERENCES fearth_parameter(parameter_id);


--
-- Name: fk_parameter_lookup_lookup; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_parameter_lookup
    ADD CONSTRAINT fk_parameter_lookup_lookup FOREIGN KEY (lookup_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_parameter_lookup_parameter; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_parameter_lookup
    ADD CONSTRAINT fk_parameter_lookup_parameter FOREIGN KEY (parameter_id) REFERENCES fearth_parameter(parameter_id);


--
-- Name: fk_parameter_obs_type; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_parameter
    ADD CONSTRAINT fk_parameter_obs_type FOREIGN KEY (observation_type_id) REFERENCES fearth_observation_type(observation_type_id);


--
-- Name: fk_parameter_observation; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_completion
    ADD CONSTRAINT fk_parameter_observation FOREIGN KEY (observation_id) REFERENCES fearth_observation(observation_id);


--
-- Name: fk_reference_biblio_reference; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_reference
    ADD CONSTRAINT fk_reference_biblio_reference FOREIGN KEY (biblio_id) REFERENCES fearth_bibliographic_reference(biblio_id);


--
-- Name: fk_reference_observation; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_reference
    ADD CONSTRAINT fk_reference_observation FOREIGN KEY (observation_id) REFERENCES fearth_observation(observation_id);


--
-- Name: fk_reference_result; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_reference
    ADD CONSTRAINT fk_reference_result FOREIGN KEY (result_id) REFERENCES fearth_result(result_id);


--
-- Name: fk_result_derivation; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_result
    ADD CONSTRAINT fk_result_derivation FOREIGN KEY (derivation_type_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_result_max_lookup; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_result
    ADD CONSTRAINT fk_result_max_lookup FOREIGN KEY (max_lookup) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_result_min_lookup; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_result
    ADD CONSTRAINT fk_result_min_lookup FOREIGN KEY (min_lookup) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_result_observation; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_result
    ADD CONSTRAINT fk_result_observation FOREIGN KEY (observation_id) REFERENCES fearth_observation(observation_id);


--
-- Name: fk_result_pref_lookup; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_result
    ADD CONSTRAINT fk_result_pref_lookup FOREIGN KEY (pref_lookup) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_section_data_completion; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_neotectonic_section
    ADD CONSTRAINT fk_section_data_completion FOREIGN KEY (completion_id) REFERENCES fearth_data_completion(data_completion_id);


--
-- Name: fk_section_octant; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_neotectonic_section
    ADD CONSTRAINT fk_section_octant FOREIGN KEY (downthrown_side_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_section_slip_type; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_neotectonic_section
    ADD CONSTRAINT fk_section_slip_type FOREIGN KEY (slip_type_id) REFERENCES fearth_lookup(lookup_id);


--
-- Name: fk_section_trace_expression; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_section_trace
    ADD CONSTRAINT fk_section_trace_expression FOREIGN KEY (expression_id) REFERENCES fearth_geomorphic_expression(expression_id);


--
-- Name: fk_section_trace_location_method; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_section_trace
    ADD CONSTRAINT fk_section_trace_location_method FOREIGN KEY (location_method_id) REFERENCES fearth_location_method(method_id);


--
-- Name: fk_section_trace_neotectonic_section; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_section_trace
    ADD CONSTRAINT fk_section_trace_neotectonic_section FOREIGN KEY (neotectonic_section_id) REFERENCES fearth_neotectonic_section(neotectonic_section_id);


--
-- Name: fk_section_user; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_neotectonic_section
    ADD CONSTRAINT fk_section_user FOREIGN KEY (compiler_id) REFERENCES fearth_gem_user(user_id);


--
-- Name: fk_section_user2; Type: FK CONSTRAINT; Schema: gem; Owner: gemdba
--

ALTER TABLE ONLY fearth_neotectonic_section
    ADD CONSTRAINT fk_section_user2 FOREIGN KEY (contributor_id) REFERENCES fearth_gem_user(user_id);


--
-- Name: gem; Type: ACL; Schema: -; Owner: gemdba
--
...
--
-- Name: databasechangelog; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: databasechangeloglock; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_bibliographic_reference; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_bibliographic_reference_biblio_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_blind_fault_summary; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_blind_fault_summary_blind_fault_summary_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_compilation_note; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_compilation_note_compilation_note_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_completion; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_completion_completion_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_data_completion; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fault_source; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fault_source_fault_source_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fault_summary; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fault_summary_fault_summary_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fault_synopsis; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fault_synopsis_fault_synopsis_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fold; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fold_fold_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fold_trace; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_fold_trace_fold_trace_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_gem_role; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_gem_user; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_gem_user_role; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_gem_user_role_user_role_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_gem_user_user_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_geomorphic_expression; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_location_method; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_lookup; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_lookup_lookup_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_neotectonic_section; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_neotectonic_section_neotectonic_section_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_observation; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_observation_observation_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_observation_type; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_parameter; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_result; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_parameter_derivation_parameter_derivation_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_parameter_lookup; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_parameter_parameter_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_reference; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_reference_reference_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_section_trace; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_section_trace_section_trace_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_site; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: fearth_site_site_id_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: tracetest; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: usa_singlepart; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: usa_singlepart_folds; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: usa_singlepart_folds_gid_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: usa_singlepart_gid_seq; Type: ACL; Schema: gem; Owner: gemdba
--



--
-- Name: usatest; Type: ACL; Schema: gem; Owner: gemdba
--
...
REVOKE ALL ON ALL TABLES IN SCHEMA gem FROM gemdba;
REVOKE ALL ON ALL TABLES IN SCHEMA PUBLIC FROM gemdba;
REVOKE SELECT ON ALL TABLES IN SCHEMA gem FROM feusers;
REVOKE SELECT ON ALL TABLES IN SCHEMA PUBLIC FROM feusers;

GRANT ALL ON ALL TABLES IN SCHEMA gem TO gemdba;
GRANT ALL ON ALL TABLES IN SCHEMA PUBLIC TO gemdba;
GRANT SELECT ON ALL TABLES IN SCHEMA gem TO feusers;
GRANT SELECT ON ALL TABLES IN SCHEMA PUBLIC TO feusers;
